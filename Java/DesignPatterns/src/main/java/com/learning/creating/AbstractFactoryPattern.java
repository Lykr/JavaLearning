...
public class AbstractFactoryPattern {
    ...
    static class ConcreteProdcutA1 implements Product1 {
        @Override
        public void show() {
    ...
    static class ConcreteProdcutA2 implements Product2 {
        @Override
        public void show() {
    ...
    static class ConcreteProdcutB1 implements Product1 {
        @Override
        public void show() {
    ...
    static class ConcreteProdcutB2 implements Product2 {
        @Override
        public void show() {
